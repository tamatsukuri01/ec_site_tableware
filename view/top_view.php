          ...
          <div class="col-lg-9">
            <div class="carousel slide my-4" id="carouselExampleIndicators" data-ride="carousel">
              ...
              <div class="carousel-inner" role="listbox">
                <div class="carousel-item active"><img class="d-block img-fluid" src="<?php print(IMG_PATH.'syokki900×350.jpg'); ?>" alt="First slide" /></div>
                <div class="carousel-item"><img class="d-block img-fluid" src="<?php print(IMG_PATH.'cafe.jpeg'); ?>" alt="Second slide" /></div>
                <div class="carousel-item"><img class="d-block img-fluid" src="<?php print(IMG_PATH.'granping900×350.jpeg'); ?>" alt="Third slide" /></div>
              </div>
